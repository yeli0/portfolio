        ...
        <div className="sub">
          ...
          <div className="sub-contents">
            <div className="sub-contents-img">
              <img src={ImgList.uzbit} alt="uzbit 사이트"/> 
            </div>
            <div className="sub-contents-txt">
              <div className="sub-contents-txt-details">
                ...
                <div>
                  ...
                  <p>
                    <a href="https://uzbit.io/" target="_blank" rel="noopener noreferrer">
                      uzbit.io
                    </a>
                  </p>
                </div>
